                                        ...
                                        @foreach($akomodasis as $akomodasi)
                                            <tr>
                                                ...
                                                <td><form action="{{ route('akomodasi.destroy', $akomodasi->id) }}" method="POST">
                                                        ...
                                                        <a href="{{ route('akomodasi.show', $akomodasi->id) }}" class="btn btn-success btn-sm">Lihat</a>
                                                        <a href="{{ route('akomodasi.edit', $akomodasi->id) }}" class="btn btn-warning btn-sm">Edit</a>
