                ...
                <div class="col-md-6">
                    @component('components.card')
                        ...
                        @slot('body')
                            ...
                            @endif
                            ​
                            <form role="form" action="{{ route('kuliner.update', $kuliner->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea  name="deskripsi" id="ckedtor" class="ckeditor" cols="5" rows="5" class="form-control {{ $errors->has('deskripsi') ? 'is-invalid':'' }}" required=""> {{$kuliner->deskripsi}} </textarea>
                                </div>
                                <div class="form-group">
                                    <label for="gambar">Gambar</label><br>
                                    <img src="{{asset('Kab/information/Kuliner/'.$kuliner->foto)}}" id="img1" style="max-width: 400px" alt=""><br><br>
