...
@section('content')
    <div class="jumbutron mt-50 ml-2 mr-2">
        <div class="jumbotron text-white jumbotron-image shadow"
             style="height:500px;background-image: url({{'/Kab/information/ObjekWisata/'.$objekWisata->foto}});background-size:2000px 1000px ;background-repeat: no-repeat">
