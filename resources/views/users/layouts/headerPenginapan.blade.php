...
@else
<nav class="navbar2 navbar-expand-lg navbar-white main" style="background-color: #833333">
   <div class="container-fluid custom-container">
   <div class="collapse navbar-collapse" id="navbarResponsive">
   <ul class="navbar-nav">
      <li class="nav-item dropdown">
         <a class="nav-link dropdown" style="color: white" href="{{ url('/product/pakaian') }}" id="navbarDropdown" role="button" aria-haspopup="true" aria-expanded="false">
         Toba
         </a>
         <div class="dropdown-menu" aria-labelledby="navbarDropdown">
         </div>
      ...
      <li class="nav-item dropdown" style="margin-left: 3rem">
         <a class="nav-link dropdown" style="color: white" href="{{ url('/product/aksesoris') }}" id="navbarDropdown" role="button" aria-haspopup="true" aria-expanded="false">
         Humbang
         </a>
         <div class="dropdown-menu" aria-labelledby="navbarDropdown">
      </li>
      <li class="nav-item dropdown" style="margin-left: 3rem">
         <a class="nav-link dropdown" style="color: white" href="{{ url('/product/makanan') }}" id="navbarDropdown" role="button" aria-haspopup="true" aria-expanded="false">
         Simalungun
         </a>
         <div class="dropdown-menu" aria-labelledby="navbarDropdown">
         </div>
      ...
      <li class="nav-item dropdown" style="margin-left: 3rem">
         <a class="nav-link dropdown" style="color: white" href="{{ url('/product/obat') }}" id="navbarDropdown" role="button"  aria-haspopup="true" aria-expanded="false">
         Samosir
         </a>
         <div class="dropdown-menu" aria-labelledby="navbarDropdown">
      </li>
      <li class="nav-item dropdown" style="margin-left: 3rem">
         <a class="nav-link dropdown" style="color: white" href="{{ url('/product/ulos') }}" id="navbarDropdown" role="button" aria-haspopup="true" aria-expanded="false">
         Tapanuli
         </a>
         <div class="dropdown-menu" aria-labelledby="navbarDropdown">
      </li>
