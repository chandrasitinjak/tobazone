   ...
   <div class="container">
      ...
      <div class="collapse navbar-collapse">
         <form class="form-inline my-2 my-lg-0 mx-auto" action="/search">
            <input class="form-control" type="search" placeholder="Cari Penginapan..." aria-label="Search" name="search">
...
<nav id="sidebar1">
   ...
   <ul class="list-unstyled components links">
      <li>
         <a href="{{ url('/product/pakaian') }}"><i class="bx bxs-t-shirt mr-3"></i> Toba</a>
      </li>
      <li>
         <a href="{{ url('/product/aksesoris') }}"><i class="bx bxs-star-half mr-3"></i> Humbang</a>
      </li>
      <li>
         <a href="{{ url('/product/makanan') }}"><i class="bx bxs-food-menu mr-3"></i> Simalungun</a>
      </li>
      <li>
         <a href="{{ url('/product/obat') }}"><i class="bx bxl-drupal mr-3"></i> Samosir</a>
      </li>
      <li>
         <a href="{{ url('/product/ulos') }}"><i class="bx bxs-bar-chart-square mr-3"></i>Tapanuli</a>
      </li>
   </ul>
</nav>
@role('merchant')
