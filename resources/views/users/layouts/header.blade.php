            ...
            <ul class="navbar-nav ml-start">
                <li class="nav-item d-lg-none dropdown">
                    ...
                    <div class="loginbutton ">
                        ...
                        @else
                            <a href="#" class="nav-link dropdown-toggle" id="navbarDropdown" role="button" data-toggle="dropdown" style="font-size: 1rem" >Profile</a>
                                ...
                                <ul class="dropdown">
                                    ...
                                    <li>
                                        <form method="POST" action="{{ url('/logout')}}">
                                            {{ csrf_field() }}
                                            <button type="submit" class="btn nav-link" style="background-color: transparent;padding-left: 12px;">Logout
                                            </button>
                                        </form>
                                    </li>
                                </ul>
