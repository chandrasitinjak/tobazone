...
<div class="row" style="padding: 2rem 0 2rem">
    ...
    <div class="col-md-9 col-lg-9">
        ...
        <div class="row">
            <p style="width: 350px">
                <b>Jenis Kelamin &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp:</b> &nbsp&nbsp&nbsp&nbsp
                {{$profiles->gender }}
            </p>
        </div>
        <div class="row">
        ...
        <div class="row" style="padding-top:15px">
            <a href="{{ url('/customer/editalamat/'.$profiles->user_id) }}" class="btn essence-btn">ubah Alamat</a>
        </div>
    </div>
</div>
@endsection
