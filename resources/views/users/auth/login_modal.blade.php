<div class="modal fade loginmodal" id="loginModal1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true"
  data-backdrop="true">
...
<div class="modal fade loginmodal" id="loginModal3" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true"
     data-backdrop="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header ">
      ...
      <div class="modal-footer  py-0 " style="border: none">
        <input type="hidden" id="hidden-cbt" value="cbt">
        <button type="submit" class="btn essence-btn btn-block" onclick="login() ">Masuk</button>
      </div>
...
<div class="modal fade loginmodal" id="loginModal4" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true"
     data-backdrop="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header ">
      ...
      <div class="modal-footer  py-0 " style="border: none">
        <input type="hidden" id="hidden-admin" value="admin">
        <button type="submit" class="btn essence-btn btn-block" onclick="login() ">Masuk</button>
      </div>
