                    ...
                    <div class="mercant-sidebar-menu">
                        <div class="col-md-12 text-center">
                            ...
                            <div class="imgwrapper imgwrapper-a mb-3 img-circle" style="padding: 0px;">
                                <img src="{{ url("/images/user_profiles/".$profiles->photo )}}" alt="Card image cap
                                test" style="object-fit: scale-down">
                            </div>
                            @else
    ...
    <div class="col-md-9 col-lg-9">
        ...
        <div class="row">
            <p style="width: 350px">
                ...
                &nbsp&nbsp&nbsp&nbsp {{ $profiles->phone }}
            </p>
        </div>
        <div class="row">
            <p style="width: 350px">
                <b>Jenis Kelamin
                    &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp:</b>
                &nbsp&nbsp&nbsp&nbsp {{ $profiles->gender }}
            </p>
        </div>
        <div class="row">
            <p style="width: 350px">
                <b>Tanggal lahir
                    &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp:</b>
                &nbsp&nbsp&nbsp&nbsp {{date('d-m-Y', strtotime($profiles->birthday))}}
            </p>
        </div>

        <div class="row" style="padding-top:15px">
            <a href="{{ url('/merchant/'.$profiles->user_id.'/editProfile') }}" class="btn essence-btn">ubah profil</a>
        </div>
        <div class="row">
            <p>Alamat</p>
            {{ $data->name}}
        ...
        <div class="row">
            <p style="width: 350px">
                ...
                &nbsp&nbsp&nbsp&nbsp {{ $data->province_name}}
            </p>
        </div>
        <div class="row">
            <p style="width: 350px">
        ...
        <div class="row">
            <p style="width: 350px">
                <b>Kecamatan &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp:</b>
                &nbsp&nbsp&nbsp&nbsp {{ $data->subdistrict_name}}
            </p>
        </div>
        <div class="row">
            <p style="width: 350px">
                ...
                &nbsp&nbsp&nbsp&nbsp {{ $data->postal_code}}
            </p>
        </div>
        <div class="row">
            <p style="width: 350px">
                <b>Alamat Rinci &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp:</b> &nbsp&nbsp&nbsp&nbsp
                {{ $data->detail}}
            </p>
        </div>
        <div class="row" style="padding-top:15px">
            <a href="{{ url('/merchant/ubahalamat/'.$profiles->user_id) }}" class="btn essence-btn">ubah alamat</a>
        </div>
    </div>
</div>
@endsection
