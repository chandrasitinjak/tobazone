...
<section class="shop_grid_area section-padding-80">
    <div class="container">
        <div class="card container bayangan-bawah" style="background-color: #FFFAF4; margin-bottom: -20px">
            <br>
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="row">
                        <form class="row pl-3 pr-3">
                            ...
                            <div class="col-lg-12 mt-4 mb-3">
                                <button type="submit" class="btn essence-btn-sm">Pesan Homestay</button>
                            </div>
                        </form>
                    </div>
                    {{--                <div class="col-md-6" align="right">--}}
