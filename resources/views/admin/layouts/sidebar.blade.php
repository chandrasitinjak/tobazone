    ...
    <nav class="navbar navbar-expand-sm navbar-default">
        ...
        <div id="main-menu" class="main-menu collapse navbar-collapse">
            <ul class="nav navbar-nav">
                ...
                <li> <a href="{{ url('/admin/cbt/new-member')}}"> <i class="menu-icon fa fa-user"></i>Daftar Member</a> </li>
                <li> <a href="{{ url('/admin/cbt/request-member')}}"> <i class="menu-icon fa fa-user"></i>Request Member</a> </li>
