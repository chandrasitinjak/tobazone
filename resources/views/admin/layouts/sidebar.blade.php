    ...
    <nav class="navbar navbar-expand-sm navbar-default">
        ...
        <div id="main-menu" class="main-menu collapse navbar-collapse">
            <ul class="nav navbar-nav">
                ...
                <h3 class="menu-title">Role and Permission</h3>
                <li> <a href="{{ url('/roles')}}"> <i class="menu-icon fa fa-key"></i>Role </a> </li>
                <li> <a href="{{ url('/permissions')}}"> <i class="menu-icon fa fa-lock"></i>Permission </a> </li>
