                        ...
                        <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                            <li>
                                ...
                                <div class="dropdown-menu" aria-labelledby="navbarDropdown" style="left: 10rem;">
                                    <a class="dropdown-item" @click="filterProductByCategory('Buatan Tangan')">Buatan
                                        Tangan</a>
                                    <a class="dropdown-item" @click="filterProductByCategory('Buatan Mesin')">Buatan
                                        Mesin</a>
                            ...
                            <li>
                                ...
                                <div class="dropdown-menu" aria-labelledby="navbarDropdown1" style="left: 23.3rem;">
                                    ...
                                    <a class="dropdown-item" @click="sortProductByDistrict('Humbang Hasundutan')">Humbang
                                        Hasundutan</a>
                                    <a class="dropdown-item" @click="sortProductByDistrict('Karo')">Karo</a>
                                    <a class="dropdown-item" @click="sortProductByDistrict('Pakpak Bharat')">Pakpak
                                        Bharat</a>
                                    ...
                                    <a class="dropdown-item" @click="sortProductByDistrict('Tapanuli Utara')">Tapanuli
                                        Utara</a>
                                    <a class="dropdown-item" @click="sortProductByDistrict('Toba Samosir')">Toba
                                        Samosir</a>
                            ...
                            <div class="card products">
                                <a :href="'/products/' + product.id">
                                    <div style="height: 250px">
                                        ...
                                        <img :src="'/images/' + JSON.parse(product.images)[0]"
                                             style='height: 100%; width: 100%; object-fit: cover' alt="Card image cap">
                                    </div>
                                </a>
                                <div class="card-body">
                                    ...
                                    <div v-if="userId != null">
                                        ...
                                        <div v-if=" ! productWishlist.includes(product.id)">
                                        ...
                                        <div v-else>
                                            <button style="border : 0px; background-color: white" class="float-right"
                                                    v-on:click="addToWishlist(product.id)"><i class="fa fa-heart"></i>
                                            </button>
                                        </div>
                                    </div>
                                </div>
                ...
                await window.axios.get("/api/customer/" + this.userId + "/wishlists/")
                    .then(res => {
                        for(var i in res.data){
                            ...
                            this.productWishlist.push(res.data[i].product_id);
                        }
                    }).catch(err => {
                        console.log(err);
                    })
