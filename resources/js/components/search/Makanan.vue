    ...
    <div class="card globalcard" style="min-height: 400px">
      <div class="card-header">
        <nav class="navbar navbar-expand-lg mproduct p-1" style="background-color: transparent; border:none">
          <h5 class="mr-3">Filter Makanan</h5>
            ...
            <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
              <li>
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown" style="left: 10rem;">
                  <a class="dropdown-item" @click="filterProductByCategory('Kering')">Kering</a>
                  <a class="dropdown-item" @click="filterProductByCategory('Basah')">Basah</a>
              ...
              <li>
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown1" style="left: 14rem;">
              ...
              <li>
                <a
                    ...
                    aria-expanded="false"
                >Kabupaten</a>
                <div class="dropdown-menu" aria-labelledby="navbarDropdown1" style="left: 22.8rem;">
