            ...
            <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
              <li>
                <a
                    ...
                    aria-expanded="false"
                >Kategori</a>
                <div class="dropdown-menu" aria-labelledby="navbarDropdown" style="left: 7rem;">
              ...
              <li>
                <a
                    ...
                    aria-expanded="false"
                >Kabupaten</a>
                <div class="dropdown-menu" aria-labelledby="navbarDropdown1" style="left: 20.3rem;">
