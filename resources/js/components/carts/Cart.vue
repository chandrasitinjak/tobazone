    ...
    <div class="card globalcard" style="min-height: 400px">
      ...
      <div class="card-body">
        ...
        <div v-else class="col-12 text-center mt-3">
          <img src="/images/assets/empty_cart.png" style="height: 120px; border: none; opacity: 0.5"/>
        ...
        <div class="row" v-for="cart in carts">
          ...
          <div class="quantity col-md-2 col-sm-12 col-xs-12">
            <div class="input-group input-group-sm">
              ...
              <input type="number" class="form-control" v-model="cart.total" v-on:change="updateCart(cart)" min="1"
