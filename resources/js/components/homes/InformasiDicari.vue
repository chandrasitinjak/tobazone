        ...
        <div class="">
            <div class="row justify-content-center">
                ...
                <a href="informasi-transportasi">
                    <div class="col-lg-auto col-auto">
                        <div class="card-informasi card shadow mt-3" style="width: 15rem;height: 18rem">
                            <img class="card-img-top" src="https://cdn-2.tstatic.net/medan/foto/bank/images/tarik-magg.jpg" alt="Card image cap" style="height: 18rem">
                            <div class="card-img-overlay">
                                <h5 class="card-title text-white">Transportasi</h5>
                            </div>
                        </div>
                    </div>
                </a>
