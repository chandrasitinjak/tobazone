...
Route::get('/admin/cbt/new-member', 'MemberController@index');

Route::get('/admin/cbt/request-member','MemberController@listRequest');
Route::get('/admin/cbt/request-member/detailMember/{id}','MemberController@detailMember');
Route::get('/admin/cbt/request-member/terimaMember/{id}','MemberController@terimaMember')->name('member.request.terima');
Route::get('/admin/cbt/request-member/tolakMember/{id}','MemberController@tolakMember')->name('member.request.tolak');